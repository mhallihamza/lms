  ...
  return (
    <div>
        <div className='flex justify-between mb-8'>
            ...
            <h4 className='text-slate-600 text-[0.8rem]'>TEACHER</h4>
            </div>
            <button onClick={()=>navigate("/Accueil/Teacher/Add")} className='bg-blue-700 text-white w-28 border border-blue-700 rounded text-xl h-9 pb-9 hover:bg-blue-800'><span className='text-2xl text-gray-300'>+</span> Create</button>
        </div>
        <div>
