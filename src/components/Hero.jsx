  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <a href='#'><button type="button" className="text-white bg-violet-400 hover:bg-fuchsia-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-lg px-7 py-2.5 text-center mr-2 mb-2 w-[11rem] dark:focus:ring-yellow-900">Contact Us</button></a>
        </div>
